...
#' an infected cattle and recovery or death. Note that the value returned and
#' associated variability is a population average, and does not reflect
...
#' @param mu the population average, defaults to 16 days
#' @param sd the standard deviation of the lognormal distribution, defaults to 
#'   0.1
#' @author Thibaut Jombart \email{thibautjombart@@gmail.com}
rlsd_infec_period <- function(n, mu = 16, sd = 0.1) {
